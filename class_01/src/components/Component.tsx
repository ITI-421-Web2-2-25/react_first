    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <ToggleButton id="tbrOtr" value={"Otro"} variant="outline-warning">
            Otro
          </ToggleButton>
        </ToggleButtonGroup>
        <p>{texto3}</p>
